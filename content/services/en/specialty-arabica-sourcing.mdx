...
keywords: ["specialty arabica sourcing", "vietnamese arabica coffee", "highland coffee sourcing", "direct trade arabica", "premium coffee sourcing", "arabica coffee import"]
pricing: {
  startingPrice: 4.50,
  currency: "USD",
  unit: "per kg",
...
minimumOrder: "300 kg"
certifications: ["Organic", "Rainforest Alliance", "Direct Trade", "SCA Certified"]
...
*"The Great Beans transformed our single-origin program. Their Da Lat Arabica has become our best-selling coffee, and the quality consistency is exceptional."* - Master Roaster, European Specialty Coffee Company
...
*"Working with The Great Beans allowed us to achieve our sustainability goals while maintaining exceptional quality and competitive pricing."* - Procurement Director, International Café Chain
...
*Experience the exceptional quality and unique terroir of Vietnamese highland Arabica. Contact our sourcing team today to discover why Vietnam represents the future of specialty coffee sourcing.*
