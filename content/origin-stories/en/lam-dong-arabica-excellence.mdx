...
farmSize: '8 hectares'
sustainabilityPractices: ['Organic certification', 'Shade-grown cultivation', 'Natural spring water irrigation', 'Composting program', 'Bird habitat preservation', 'Carbon-neutral processing']
...
The washed processing method used at the farm involves: 1. **Pulping**: Within 6 hours of harvest using a eco-friendly pulper
