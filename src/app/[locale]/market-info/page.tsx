...
export async function generateMetadata({
  ...
  return generateSEOMetadata({
    ...
    description: t('description', {
      default:
        'Comprehensive market-specific information for coffee export operations, including currency, shipping details, certifications, and business requirements.',
    }),
    locale,
    url: '/market-info',
    type: 'website',
...
export default async function MarketInfoPage({ params }: MarketInfoPageProps) {
  ...
  const webPageSchema = {
    ...
    mainEntity: {
      ...
      description:
        'Market-specific data for international coffee export operations',
      keywords: [
        'coffee export',
        'market information',
        'shipping data',
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-gray-600">
                ...
                operations, including currency, shipping details,
                certifications, and business requirements.
              </p>
            </div>
          </div>
            ...
            <CardContent>
              <div className="prose max-w-none">
                ...
                <ul className="mb-6 list-inside list-disc space-y-2 text-gray-700">
                  <li>
                    <strong>Currency & Pricing:</strong> Local currency
                    formatting and pricing display
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Business Hours:</strong> Local timezone and
                    operating hours
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Payment Terms:</strong> Preferred payment methods
                    and standard terms
                  </li>
                  <li>
                ...
                <p className="text-gray-700">
                  This information is automatically updated based on your
                  selected locale and helps ensure compliance with local
