...
import { Zap, Clock, Globe, Droplets, CheckCircle, Star, Package } from 'lucide-react';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return {
    title: 'Premium Instant Coffee - Vietnamese Robusta & Arabica - The Great Beans',
    description: 'High-quality instant coffee made from premium Vietnamese Robusta and Highland Arabica. Spray-dried and freeze-dried options for global markets.',
    openGraph: {
      title: 'Premium Instant Coffee - Vietnamese Robusta & Arabica - The Great Beans',
      description: 'Premium instant coffee solutions with superior solubility, rich flavor, and consistent quality for global markets.',
      type: 'website',
    },
  };
}
    ...
    <div className="min-h-screen">
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-forest-700 md:text-2xl">
              Superior instant coffee solutions made from premium Vietnamese beans. 
              Perfect solubility, rich flavor, and consistent quality for global markets.
            </p>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-forest-900">Superior Solubility</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-forest-900">Extended Shelf Life</h3>
                  <p className="text-forest-600">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-forest-900">Global Standards</h3>
                  <p className="text-forest-600">
      ...
      <section className="bg-forest-50 py-20">
        <div className="container">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold text-forest-900">Product Specifications</h2>
              <p className="text-lg text-forest-600">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <p className="text-forest-600">Premium grade for commercial use</p>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    <h4 className="mb-3 font-semibold text-forest-900">Technical Specifications</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-forest-600">Moisture Content:</span>
                  ...
                  <div>
                    <h4 className="mb-3 font-semibold text-forest-900">Applications</h4>
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                        <span className="text-forest-600">Vending machines</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                        <span className="text-forest-600">Food service industry</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                        <span className="text-forest-600">3-in-1 coffee mixes</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-forest-600">Premium grade for specialty markets</p>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    <h4 className="mb-3 font-semibold text-forest-900">Technical Specifications</h4>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                        <span className="text-forest-600">Premium retail brands</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                      ...
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
                        <span className="text-forest-600">High-end hospitality</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500" />
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="mb-2 text-xl font-semibold text-forest-900">Coffee Extraction</h3>
                  <p className="text-forest-600">
                    Premium green coffee beans are roasted to perfection and then 
                    extracted using controlled temperature and pressure to preserve 
                    maximum flavor and aroma compounds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="mb-2 text-xl font-semibold text-forest-900">Concentration</h3>
                  <p className="text-forest-600">
                    The coffee extract is concentrated using vacuum evaporation 
                    at low temperatures to maintain flavor integrity while removing 
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="mb-2 text-xl font-semibold text-forest-900">Drying Process</h3>
                  <p className="text-forest-600">
                    The concentrated extract undergoes either spray-drying for 
                    cost-effective production or freeze-drying for premium quality, 
                    resulting in instant coffee powder or granules.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="mb-2 text-xl font-semibold text-forest-900">Quality Control & Packaging</h3>
                  <p className="text-forest-600">
                    Final products undergo rigorous quality testing for solubility, 
                    moisture content, and flavor profile before being packaged in 
                    moisture-proof containers for optimal preservation.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-forest-50 py-20">
        <div className="container">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold text-forest-900">Packaging Options</h2>
              <p className="text-lg text-forest-600">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-forest-900">Bulk Packaging</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-forest-900">Retail Packaging</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
      ...
      <section className="py-20">
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold text-forest-900">Why Choose Our Instant Coffee?</h2>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="mb-1 font-semibold text-forest-900">Premium Raw Materials</h3>
                  <p className="text-forest-600">Made from carefully selected Vietnamese Robusta and Arabica beans</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 flex-shrink-0 text-emerald-500" />
                <div>
                  <h3 className="mb-1 font-semibold text-forest-900">Advanced Technology</h3>
                  <p className="text-forest-600">State-of-the-art processing equipment for consistent quality</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 flex-shrink-0 text-emerald-500" />
                <div>
                  <h3 className="mb-1 font-semibold text-forest-900">Global Certifications</h3>
                  <p className="text-forest-600">FDA, EU, HACCP certified for international markets</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-forest-600">Direct from source pricing with no intermediaries</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 flex-shrink-0 text-emerald-500" />
                <div>
                  <h3 className="mb-1 font-semibold text-forest-900">Flexible MOQ</h3>
                  <p className="text-forest-600">Minimum order quantities suitable for all business sizes</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 flex-shrink-0 text-emerald-500" />
                <div>
                  <h3 className="mb-1 font-semibold text-forest-900">Reliable Supply</h3>
                  <p className="text-forest-600">Consistent supply chain with 14+ years of experience</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-forest-600">
              ...
              From small batches to container loads, we have the solution for your needs.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Button asChild size="lg" className="bg-amber-600 hover:bg-amber-700">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href={`/${params.locale}/contact`}>Technical Support</Link>
              </Button>
            </div>
          </div>
        </div>
