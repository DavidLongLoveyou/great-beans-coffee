...
export async function generateMetadata({
  ...
  return generateSEOMetadata({
    ...
    description:
      "Comprehensive B2B coffee services including OEM manufacturing, private label solutions, coffee sourcing, and logistics. Partner with Vietnam's leading coffee export company.",
    keywords: [
      'b2b coffee services',
...
export default async function ServicesPage({ params }: ServicesPageProps) {
  ...
  const servicesCollectionSchema = {
    ...
    description:
      'Comprehensive B2B coffee services including OEM manufacturing, private label solutions, coffee sourcing, and logistics.',
