  ...
  const handleSubmit = async () => {
    try {
      ...
      const rfqRequest = {
        ...
        urgency: formData.urgencyReason
          ? 'high'
      ...
      // Handle error silently or with proper error state management
      // In production, this would be logged to an error tracking service
      // The error state is already managed by the useRfqForm hook
    }
  };
      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl text-gray-600">
            Get competitive pricing for your coffee requirements. Our team will
            provide a detailed quotation based on your specifications.
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="JUTE_BAGS_60KG">
                          Jute Bags (60kg)
                        </SelectItem>
                        <SelectItem value="JUTE_BAGS_69KG">
                          Jute Bags (69kg)
                        </SelectItem>
                        <SelectItem value="PP_BAGS_60KG">
                          PP Bags (60kg)
                        </SelectItem>
                        <SelectItem value="BULK_CONTAINER">
                          Bulk Container
                        </SelectItem>
                        <SelectItem value="VACUUM_BAGS">Vacuum Bags</SelectItem>
                        <SelectItem value="CUSTOM_PACKAGING">
                          Custom Packaging
                        </SelectItem>
                      </SelectContent>
                    </Select>
                ...
                <div className="rounded-lg bg-gray-50 p-6">
                  ...
                  <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                    <div>
                      ...
                      {formData.coffeeType || 'Not specified'}
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      {formData.destinationPort || 'Not specified'}
                    </div>
                    <div>
