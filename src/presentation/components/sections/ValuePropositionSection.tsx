  ...
  const valueProps = [
    {
      ...
      description:
        'ISO 22000 certified facilities with rigorous quality control at every stage',
      features: [
        'ISO 22000 Certified',
        'HACCP Compliant',
        'Third-party Audited',
    ...
    },
    {
      ...
      description:
        "Direct sourcing from Vietnam's finest coffee growing regions",
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-white via-forest-50 to-emerald-50 py-24">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute right-10 top-10 h-28 w-28 animate-pulse rounded-full bg-forest-400"></div>
        <div className="absolute bottom-10 left-10 h-36 w-36 animate-pulse rounded-full bg-emerald-400 delay-1000"></div>
        <div className="absolute left-1/3 top-1/2 h-20 w-20 animate-pulse rounded-full bg-forest-300 delay-500"></div>
      </div>
            ...
            return (
              <Card
                ...
                className={`group relative overflow-hidden border-2 transition-all duration-500 hover:-translate-y-2 ${
                  isEmerald
                    ? 'hover:shadow-emerald-strong border-emerald-200 bg-white/80 hover:border-emerald-300'
                ...
                <CardHeader className="relative pb-4">
                  <div
                    className={`mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl transition-all duration-300 group-hover:scale-110 ${
                      isEmerald
                        ? 'group-hover:shadow-emerald-medium bg-gradient-to-br from-emerald-100 to-emerald-200 shadow-emerald-soft'
                        : 'bg-gradient-to-br from-forest-100 to-forest-200 shadow-forest-soft group-hover:shadow-forest-medium'
                    }`}
                  >
                    <Icon
                      className={`h-10 w-10 ${isEmerald ? 'text-emerald-600' : 'text-forest-600'}`}
                    />
                  </div>
                ...
                <CardContent className="relative text-center">
                  ...
                  <div className="space-y-2">
                    {prop.features.map(feature => (
                      ...
                      >
                        <CheckCircle
                          className={`h-4 w-4 flex-shrink-0 ${isEmerald ? 'text-emerald-500' : 'text-forest-500'}`}
                        />
                        <span className="font-medium text-forest-700">
                          {feature}
                        </span>
