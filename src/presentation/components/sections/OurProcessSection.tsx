      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-4xl text-xl leading-relaxed text-forest-700">
            From sustainable farming partnerships to global logistics, discover
            how we ensure the highest quality Vietnamese coffee reaches your
            business
          </p>
        </div>
          ...
          <Card className="border-forest-200 bg-gradient-to-r from-forest-900 to-emerald-900 shadow-forest-strong">
            <CardContent className="p-12">
              ...
              <p className="mb-8 text-xl text-forest-100">
                Our proven process delivers premium Vietnamese coffee to 45+
                countries
              </p>
