...
function convertArraysToMultiLine(content) {
  ...
  fixed = fixed.replace(/chartTypes:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
  ...
  fixed = fixed.replace(/targetMarkets:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
    const items = arrayContent
      .split(',')
      .map(item => item.trim().replace(/['"]/g, ''))
      .filter(item => item);
  ...
  fixed = fixed.replace(/certifications:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
    const items = arrayContent
      .split(',')
      .map(item => item.trim().replace(/['"]/g, ''))
      .filter(item => item);
  ...
  fixed = fixed.replace(/relatedPosts:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
    const items = arrayContent
      .split(',')
      .map(item => item.trim().replace(/['"]/g, ''))
      .filter(item => item);
  ...
  fixed = fixed.replace(/relatedReports:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
    const items = arrayContent
      .split(',')
      .map(item => item.trim().replace(/['"]/g, ''))
      .filter(item => item);
  ...
  fixed = fixed.replace(/serviceIncludes:\s*\[([^\]]+)\]/g, (match, arrayContent) => {
    const items = arrayContent
      .split(',')
      .map(item => item.trim().replace(/['"]/g, ''))
      .filter(item => item);
