...
function fixYamlDelimiters(content) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (inYaml && (line.startsWith('#') || (line.length > 0 && !line.includes(':') && !line.startsWith('-') && !line.startsWith('[')))) {
...
console.log(`Checking ${mdxFiles.length} MDX files for YAML delimiter issues...`);
